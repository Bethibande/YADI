...
class DefaultContainer: Container {
    ...
    override fun inject(searchable: Searchable): Container = apply { views.add(searchable) }

    override fun inject(searchable: Collection<Searchable>): Container = apply { views.addAll(searchable) }

    override fun inject(vararg searchable: Searchable): Container = apply { views.addAll(searchable) }
